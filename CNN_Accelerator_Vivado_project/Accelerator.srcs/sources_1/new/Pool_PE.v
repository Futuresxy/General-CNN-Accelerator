...
(
  ...
  input         rstn,
  input                                     refresh,
  input  signed [2*DATA_WIDTH-1:0] io_inAct1,
  input  signed [2*DATA_WIDTH-1:0] io_inAct2,
  output signed [2*DATA_WIDTH-1:0] io_outAnswer,
  input                      io_Max_MeanValid
);
  reg [2*DATA_WIDTH-1:0] outAnswer_reg; // @[Pool_PE.scala 15:28]
