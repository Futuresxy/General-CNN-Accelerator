...
#
# Generated by export_simulation on Sun Feb 09 15:31:56 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './CNN_Module.sh' script.

./CNN_Module.sh -reset_run
...
./CNN_Module.sh -noclean_files

For more information on the script, please type './CNN_Module.sh -help'.
